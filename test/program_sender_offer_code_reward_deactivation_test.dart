...
// tests for ProgramSenderOfferCodeRewardDeactivation
void main() {
  // final instance = ProgramSenderOfferCodeRewardDeactivation();

  group('test ProgramSenderOfferCodeRewardDeactivation', () {
