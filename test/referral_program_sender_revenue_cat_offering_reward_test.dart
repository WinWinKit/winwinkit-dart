...
// tests for ReferralProgramSenderRevenueCatOfferingReward
void main() {
  // final instance = ReferralProgramSenderRevenueCatOfferingReward();

  group('test ReferralProgramSenderRevenueCatOfferingReward', () {
    // The reward
