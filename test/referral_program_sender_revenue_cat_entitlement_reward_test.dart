...
// tests for ReferralProgramSenderRevenueCatEntitlementReward
void main() {
  // final instance = ReferralProgramSenderRevenueCatEntitlementReward();

  group('test ReferralProgramSenderRevenueCatEntitlementReward', () {
    // The reward
