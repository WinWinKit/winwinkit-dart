...
// tests for ProgramReceiverCreditRewardDeactivation
void main() {
  // final instance = ProgramReceiverCreditRewardDeactivation();

  group('test ProgramReceiverCreditRewardDeactivation', () {
