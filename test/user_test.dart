...
void main() {
  ...
  group('test User', () {
    ...
    // String appUserId
    test('to test the property `appUserId`', () async {
      // TODO
    });
    ...
    // String previewLink
    test('to test the property `previewLink`', () async {
      // TODO
    });
    ...
    test('to test the property `firstSeenAt`', () async {
      // TODO
    });
    ...
    test('to test the property `claimCodeEligibility`', () async {
      // TODO
    });
