...
// tests for ReferralProgramSenderCreditRewardActivation
void main() {
  // final instance = ReferralProgramSenderCreditRewardActivation();

  group('test ReferralProgramSenderCreditRewardActivation', () {
