...
// tests for ReferralProgramReceiverRevenueCatEntitlementReward
void main() {
  // final instance = ReferralProgramReceiverRevenueCatEntitlementReward();

  group('test ReferralProgramReceiverRevenueCatEntitlementReward', () {
    // The reward
