...
// tests for ProgramReceiverOfferCodeRewardDeactivation
void main() {
  // final instance = ProgramReceiverOfferCodeRewardDeactivation();

  group('test ProgramReceiverOfferCodeRewardDeactivation', () {
