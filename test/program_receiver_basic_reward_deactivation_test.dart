...
// tests for ProgramReceiverBasicRewardDeactivation
void main() {
  // final instance = ProgramReceiverBasicRewardDeactivation();

  group('test ProgramReceiverBasicRewardDeactivation', () {
