...
class UserRewardsActive {
  ...
  @override
  String toString() => 'UserRewardsActive[basic=$basic, credit=$credit, offerCode=$offerCode, revenuecatEntitlement=$revenuecatEntitlement, revenuecatOffering=$revenuecatOffering]';
