...
part 'user_rewards_active.g.dart';
...
@BuiltValue()
abstract class UserRewardsActive implements Built<UserRewardsActive, UserRewardsActiveBuilder> {
  ...
  factory UserRewardsActive([void updates(UserRewardsActiveBuilder b)]) = _$UserRewardsActive;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UserRewardsActiveBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UserRewardsActive> get serializer => _$UserRewardsActiveSerializer();
}

class _$UserRewardsActiveSerializer implements PrimitiveSerializer<UserRewardsActive> {
  @override
  final Iterable<Type> types = const [UserRewardsActive, _$UserRewardsActive];

  @override
  final String wireName = r'UserRewardsActive';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UserRewardsActive object, {
  ...
  void _deserializeProperties(
    ...
    required UserRewardsActiveBuilder result,
  ...
  @override
  UserRewardsActive deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UserRewardsActiveBuilder();
